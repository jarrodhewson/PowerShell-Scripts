...
$LicenseGroup = "CloudLicense_EMS"
$LicenseName = "Lexel1:EMS"
...
# if no users in group abort script, no users detected is bound to be an issue. Stops all existing users having licenses removed by mistake.
